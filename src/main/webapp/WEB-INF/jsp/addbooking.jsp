...
<div class="row" style="margin-top: 150px" align="center">
    ...
    <form style="margin-top: 150px" method="POST" action="/addBooking">
        ...
        <div>
          ...
          <div class="input-group col-md-4">
              <input type="email" class="form-control" style="margin-left: 40px; margin-top: 10px" name="customerEmail" placeholder="customerEmail">
          </div>
        </div>
        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
        <button type="submit" class="btn btn-dark col-md-3" style="margin-left: 60px; margin-top: 25px">Add Booking</button>
    </form></div>
