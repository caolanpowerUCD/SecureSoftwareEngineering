...
<div class="row" style="margin-top: 150px" align="center">
    ...
    <form style="margin-top: 150px" method="POST" action="/signupExecutiveUser">
        <div class="form-group col-md-4">
            ...
            <div class="input-group col-md-4">
                <input type="text" class="form-control" style="margin-left: 40px; margin-top: 10px" name="username" placeholder="Username">
            </div>

            <div class="input-group col-md-4">
                <input type="password" class="form-control" style="margin-left: 40px; margin-top: 20px" minlength="8" pattern=".*[a-zA-Z\d].*[a-zA-Z\d!@#$%&*]" name="password" placeholder="Password">
            </div>
        </div>
        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
        <button type="submit" class="btn btn-dark col-md-3" style="margin-left: 60px; margin-top: 25px">Register</button>
    </form></div>

<script>alert("Email is already in use. Please try again")</script>
</body>
</html>