...
<div class="row" style="margin-top: 150px" align="center">
    ...
    <form id="updateForm" style="margin-top: 150px" method="POST" action="/password">
        <div class="form-group col-md-4">
            <label class="font-weight-bold" align="center">Update Password</label>
            ...
            <div class="input-group col-md-4">
                <input type="password" class="form-control" style="margin-left: 40px" name="oldPassword" placeholder="Old Password">
            </div>

            <div class="input-group col-md-4">
                <input type="password" class="form-control" style="margin-left: 40px; margin-top: 5px" name="newPassword" placeholder="New Password">
            </div>
        </div>
        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
        <button type="submit" form="updateForm" class="btn btn-dark col-md-3" style="margin-left: 60px; margin-top: 25px">Update Password</button>
    </form></div>
