    ...
    <table align="center" border="1" cellpadding="5">
        ...
        <tr>
            ...
            <tr>
                ...
                <td><c:out value="${flightdetails.flightOrigin}" /></td>
                <td><c:out value="${flightdetails.flightDestination}" /></td>
                <td><c:out value="${flightdetails.departureDate}" /></td>
                <td><c:out value="${flightdetails.totalSeats}" /></td>
            </tr>
...
<div class="row" style="margin-top: 150px" align="center">
    ...
    <form style="margin-top: 150px" method="POST" action="/doEditFlight/${flightdetails.flightId}">
        <div class="form-group col-md-4">
            <label class="font-weight-bold" align="center">Update Flight Details</label>

            <div class="input-group col-md-4">
                <input type="text" class="form-control" style="margin-left: 40px" name="flightOrigin" value ="${flightdetails.flightOrigin}">
            </div>

            <div class="input-group col-md-4">
                <input type="text" class="form-control" style="margin-left: 40px" name="flightDestination" value ="${flightdetails.flightDestination}">
            </div>

            <div class="input-group col-md-4">
                <input type="text" class="form-control" style="margin-left: 40px" name="departureDate" value ="${flightdetails.departureDate}">
            </div>

            <div class="input-group col-md-4">
                <input type="text" class="form-control" style="margin-left: 40px" name="totalSeats" value ="${flightdetails.totalSeats}">
            </div>
        </div>
